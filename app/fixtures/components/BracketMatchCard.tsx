...
export const BracketMatchCard = ({
  ...
  return (
    <div className="w-[210px] rounded-xl border transition-all duration-300 shadow-lg bg-[#0c0824]/90 backdrop-blur-md border-white/20 hover:border-primary/40 hover:shadow-[0_0_20px_rgba(139,92,246,0.15)] hover:-translate-y-0.5">
      {/* Match Header */}
      <div className="flex items-center justify-between border-b border-white/15 px-3 py-1.5 bg-white/[0.04] text-[9px] font-bold text-zinc-300">
      ...
      <div className="p-2.5 space-y-2">
        ...
        <div className="flex items-center justify-between text-xs">
          <div className={`flex items-center gap-2 font-bold ${hasPlayed && !isWinner(match, 1) ? "text-zinc-400" : "text-zinc-100"}`}>
        ...
        {/* Team 2 */}
        <div className="flex items-center justify-between text-xs">
          <div className={`flex items-center gap-2 font-bold ${hasPlayed && !isWinner(match, 2) ? "text-zinc-400" : "text-zinc-100"}`}>
      ...
      {/* Match DateTime */}
      <div className="flex items-center gap-1 border-t border-white/15 px-3 py-1.5 bg-white/[0.04] text-[8px] font-semibold text-zinc-300">
